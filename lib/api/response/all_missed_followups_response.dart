...
class AllMissedFupsRes {
  bool? success;
  int? total;
  int? totalPages;
  int? currentPage;
  List<MissedFUpsData>? data;
  ...
  AllMissedFupsRes.fromJson(Map<String, dynamic> json) {
    ...
    if (json['data'] != null) {
      data = <MissedFUpsData>[];
      json['data'].forEach((v) {
        data!.add(MissedFUpsData.fromJson(v));
      });
    }
    if (json['data'] != null) {
      final List<dynamic> dataList = json['data'];
      data = dataList.map((v) => MissedFUpsData.fromJson(v)).toList();
    } else {
      data = [];
    }
  }
...
//   TimelineMissedFUps({this.stage, this.note, this.agent, this.action, this.date});

//   TimelineMissedFUps.fromJson(Map<String, dynamic> json) {
//     stage = json['stage'] ?? '';
//     note = json['note'] ?? '';
//     agent = json['agent'] ?? '';
//     action = json['action'] ?? '';
